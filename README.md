...
[![CI](https://github.com/Ikteder/ExifVeil/actions/workflows/ci.yml/badge.svg)](https://github.com/Ikteder/ExifVeil/actions/workflows/ci.yml)
...
The completed native verification ran six tests in the Swift package and the same six tests in an iOS Simulator, all with zero failures. XcodeGen generation and the SwiftUI application build also passed.
